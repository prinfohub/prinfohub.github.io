...
<div id="wrapper">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="top-area">
			<div class="container">
				<div class="row">
					...
					<p class="bold text-left">Monday - Sunday, 8am to 10pm </p>
					</div>
					<div class="col-sm-6 col-md-6">
					<p class="bold text-right">Call us now +919204128561</p>
					</div>
				</div>
			</div>
		</div>
        <div class="container navigation">
            ...
            <div class="navbar-header page-scroll pd-tp-10">
                <a class="navbar-brand" href="index.html">
					<big><i class="fa fa-medkit"></i></big> Ghar Par Dawa
                </a>
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			...
			<div class="carousel-caption">
				<h3 class="text-wh">Best Pathology Services</h3>
				<p>We provide you best pathology services with modern technology biotechs.</p>
			</div>
		</div>
		<div class="item">
			<img src="image/carousel/2.jpg" />
			<div class="carousel-caption">
				<h3 class="text-wh">Affordable Packages</h3>
				<p>We Provide you the best affordable health packages to choose from.</p>
			</div>
		</div>
		<div class="item">
			<img src="image/carousel/3.jpg" />
			<div class="carousel-caption">
				<h3 class="text-wh">Search Your Medicine</h3>
				<p>Search Your required medicine easily through our website</p>
			</div>
		</div>
		<div class="item">
			<img src="image/carousel/4.jpg" />
			<div class="carousel-caption">
				<h3 class="text-wh">Find Nearest Chemist</h3>
				<p>You can easily find your nearest chemist available in your local area.</p>
			</div>
		</div>
	</div>
				...
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						<div class="box text-center">
							...
							<a href="" class="btn btn-dnbox btn-sm " data-toggle="modal" data-target="#medicine-modal">Search Now</a>
						</div>
					</div>
				</div>
				<div class="col-sm-4 col-md-4">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						<div class="box text-center">
							...
							<a href="" class="btn btn-dnbox btn-sm" data-toggle="modal" data-target="#pathology-modal">Book Now</a>
						</div>
					</div>
				</div>
				<div class="col-sm-2 col-md-2"></div>
						...
						<div class="callaction bg-gray">
							<div class="row">
								<div class="col-md-9">
									...
									<p>If you are facing any difficulty or if you dont find your required medicine, then feel free to contact us any time.</p>
									</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="wow lightSpeedIn" data-wow-delay="0.1s">
										<div class="cta-btn">
										<button class="btn btn-skin btn-lg" data-toggle="modal" data-target="#contact-modal">Contact Us</a>	
										</div>
									</div>
								</div>
							</div>
	...
	<section id="service" class="home-section nopadding paddingtop-60">
        ...
        <div class="row">
			...
			<div class="col-sm-3 col-md-3">
                ...
                <div class="service-box">
					...
					<div class="service-desc">
						<h5 class="h-light">Search Medicine</h5>
						<p>Easily search and buy required medicines.</p>
					</div>
                </div>
				</div>
				...
				<div class="service-box">
					...
					<div class="service-desc">
						<h5 class="h-light">Nearest Chemist</h5>
						<p>Choose your nearest chemist to buy from.</p>
					</div>
                </div>
				</div>
				...
				<div class="service-box">
					<div class="service-icon">
						<span class="fa fa-align-right fa-3x"></span> 
					</div>
					<div class="service-desc">
						<h5 class="h-light">Best Packages</h5>
						<p>We provide you the best affordable packages.</p>
					</div>
                </div>
				</div>
			...
			<div class="col-sm-3 col-md-3">
                ...
                <div class="service-box">
					<div class="service-icon">
						<span class="fa fa-reply fa-3x"></span> 
					</div>
					<div class="service-desc">
						<h5 class="h-light">Quick reply</h5>
						<p>Get a quick reply of your booking confirmation.</p>
					</div>
                </div>
				</div>
				...
				<div class="service-box">
					...
					<div class="service-desc">
						<h5 class="h-light">Contact Medical</h5>
						<p>Contact our medical for any of your queries.</p>
					</div>
                </div>
				</div>
				<div class="wow fadeInRight" data-wow-delay="0.3s">
				<div class="service-box">
					...
					<div class="service-desc">
						...
						<p>Book a test in our pathology centre</p>
					</div>
                </div>
				</div>
...
<div class="container">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12" >
                    ...
                    <?php
						$dsp = "<div class='item'>
									...
									<img src='img/photo/1.jpg' class='img-responsive' alt='mg'>
									<center><p class='mg-0'><b>Medicine One Name</b></p>
									<p class='mg-0'><small><small>this is the description of the above medicine</small></small></p>
									<p class='mg-0'><del>Rs 2400</del> &nbsp; Rs2000</p>
									</center>
									</a>
								</div>";
						for($i=0;$i<6;$i++){
    ...
    <section id="facilities" class="home-section paddingbot-60 pd-tp-0">
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="section-heading text-center">
					<h2 class="h-bold">Seasonal Product</h2>
					</div>
					</div>
					<div class="divider-short"></div>
				</div>
...
<div class="container">
			<div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" >
					<div class="wow bounceInUp" data-wow-delay="0.2s">
                    <div id="owl-seasonal" class="owl-carousel">
                    <?php
						$dsp = "<div class='item'>
									<a href='img/photo/1.jpg' title='This is an image title' data-lightbox-gallery='gallery1' data-lightbox-hidpi='img/works/1@2x.jpg'>
									<img src='img/photo/1.jpg' class='img-responsive' alt='mg'>
		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="section-heading text-center">
					<h2 class="h-bold">Top Selling Product</h2>
					</div>
					</div>
					<div class="divider-short"></div>
				</div>
...
<div class="container">
			<div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12" >
					<div class="wow bounceInUp" data-wow-delay="0.2s">
                    <div id="owl-top-selling" class="owl-carousel">
                    <?php
						$dsp = "<div class='item'>
									<a href='img/photo/1.jpg' title='This is an image title' data-lightbox-gallery='gallery1' data-lightbox-hidpi='img/works/1@2x.jpg'>
									<img src='img/photo/1.jpg' class='img-responsive' alt='mg'>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="text-left">
					<p><b>All rights reserved &copy; Apna Medical-2017</b></p>
					</div>
					</div>
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="text-right">
						<div class="credits"><b>Develpoed & Managed By
                               <a href="http://www.prinfohub.in/" target="_blank">PR InfoHub</a>
                       </b> </div>
					</div>
					</div>
				</div>
